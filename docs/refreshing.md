...
- Hover a provider heading and click its refresh icon to force only that provider. If its current refresh is stuck, this cancels and replaces that attempt; a late result from the old attempt is ignored.
